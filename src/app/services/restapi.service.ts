...
constructor(private http:HttpClient) { 
  ...
  public login(username, password,role){
    ...
    return this.http.get( 'http://localhost:8080/User/' + username + '/' + password + '/' +role  );
  ...
  public sendMessage(messageText){
    return this.http.get('http://localhost:8080/sendMessage/'+ messageText,{ responseType: 'text' as 'json'});
  }
  public getMessage(){
